                ...
                <div className="grid md:grid-cols-4 gap-12">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <div className="flex flex-row gap-6">
                            ...
                            <div className="flex gap-3 pt-1">
                                <a href="https://www.instagram.com/crawfordnotchcamping/" target="_blank" rel="noopener noreferrer" className="border border-cream/25 hover:bg-rust hover:border-rust p-2.5 rounded-sm transition-colors" aria-label="Instagram">
