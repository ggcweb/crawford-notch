                ...
                <div className="max-w-6xl mx-auto px-6 py-2.5 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <a href="https://www.instagram.com/crawfordnotchcamping/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-cream/75 hover:text-ochre transition-colors">
